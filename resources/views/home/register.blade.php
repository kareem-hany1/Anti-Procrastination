<x-layout>
    ...
    <div class="layout-container flex h-full grow flex-col">
        <x-header/>
        <form method="post" action="/register" class="px-4 sm:px-8 md:px-20 lg:px-40 flex justify-center py-5">
            @csrf

            <div class="layout-content-container flex flex-col w-full sm:w-[512px] max-w-[512px] py-5">
                <h2 class="text-white tracking-light text-2xl sm:text-[28px] font-bold leading-tight px-4 text-center pb-3 pt-5">S'inscrire</h2>
                @error('email')
                ...
                <div class="flex max-w-[480px] flex-wrap items-end gap-4 px-4 py-3">
                    <label class="flex flex-col min-w-40 flex-1">
                        <p class="text-white text-sm sm:text-base font-medium leading-normal pb-2">Nom Complet</p>
                        <input
                            type="text"
